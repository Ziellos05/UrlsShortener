export async function postData(data: { username: string | null | undefined; password: string; }) {
    const url = "https://asurlshortenerdev.azurewebsites.net/user"
  ...
  export const getData = async (token: string) => {
    const response = await fetch('https://asurlshortenerdev.azurewebsites.net/urls', {
